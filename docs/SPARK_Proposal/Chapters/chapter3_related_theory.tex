...
\begin{figure}[H]
	...
	\caption{ESP32-S3}\label{fig:esp32_devkit}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Li-ion/LiPo Cell}\label{fig:pwr_cell}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Charge/Protection Circuit}\label{fig:pwr_tp4056}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Velcro Wrist Strap}\label{fig:velcro_strap}
\end{figure}

\subsubsection{USB-C Cables}

Standard USB-C cables are used to power and program the ESP32-S3 boards and to charge the wearable's battery via the onboard charge/protection circuit during bench testing.

\begin{figure}[H]
	\centering
	\includegraphics[height=2.6cm,keepaspectratio]{micro_usb_cable.png}
	\caption{USB-C Cable}\label{fig:micro_usb_cable}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Resistor}\label{fig:resistor}
\end{figure}
