...
Evaluation (proposal sec.5, verbatim): Results are reported for both the
...
def main():
    ...
    if len(tflite_bytes) <= 120 * 1024:
        print("  [PASS] Within 120 KB flash target")
    else:
        print("  [FAIL] Exceeds 120 KB flash target -- review model architecture", file=sys.stderr)
