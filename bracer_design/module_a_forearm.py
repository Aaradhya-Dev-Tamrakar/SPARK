...
def run(_context: str):
    ...
    for i in range(n):
        x0 = i * (L / n)
        x1 = (i+1) * (L / n)
        lines.addByTwoPoints(adsk.core.Point3D.create(x0, -gw/2, 0), adsk.core.Point3D.create(x1, -gw/2, 0))
        lines.addByTwoPoints(adsk.core.Point3D.create(x1, -gw/2, 0), adsk.core.Point3D.create(x1, gw/2, 0))
        lines.addByTwoPoints(adsk.core.Point3D.create(x1, gw/2, 0), adsk.core.Point3D.create(x0, gw/2, 0))
        lines.addByTwoPoints(adsk.core.Point3D.create(x0, gw/2, 0), adsk.core.Point3D.create(x0, -gw/2, 0))
    ...
    for i in range(n):
        ...
        x1 = (i+1) * (L / n)
        yc = 0
        lines.addByTwoPoints(adsk.core.Point3D.create(x0, yc - dw/2, 0), adsk.core.Point3D.create(x1, yc - dw/2, 0))
        lines.addByTwoPoints(adsk.core.Point3D.create(x1, yc - dw/2, 0), adsk.core.Point3D.create(x1, yc - dw/2 + dh, 0))
        lines.addByTwoPoints(adsk.core.Point3D.create(x1, yc - dw/2 + dh, 0), adsk.core.Point3D.create(x0, yc - dw/2 + dh, 0))
        lines.addByTwoPoints(adsk.core.Point3D.create(x0, yc - dw/2 + dh, 0), adsk.core.Point3D.create(x0, yc - dw/2, 0))
    ...
    print("Module A (Forearm Segment) created: " + feat.name + " | LED groove=12mm, Dovetail=12x4.5mm")